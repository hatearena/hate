...
char *entmdlnames[] = {
    "shells", "bullets",  "rockets",  "rrounds", "health",
...
struct itemstat {
  int add, max, sound;
    ...
    5,   25,  S_ITEMAMMO,   25,  100, S_ITEMHEALTH, 50,    200,   S_ITEMHEALTH,
    100, 100, S_ITEMARMOUR, 150, 150, S_ITEMARMOUR, 20000, 30000, S_ITEMPUP,
};
