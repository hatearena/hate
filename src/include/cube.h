...
#define vreject(v, u, max)                                                     \
  ((v).x > (u).x + (max) || (v).x < (u).x - (max) || (v).y > (u).y + (max) ||  \
   (v).y < (u).y - (max))
...
#define VARF(name, min, cur, max, body)                                        \
  void var_##name();                                                           \
  static int name = variable(#name, min, cur, max, &name, var_##name, false);  \
  void var_##name() { body; }
#define VARFP(name, min, cur, max, body)                                       \
  void var_##name();                                                           \
  static int name = variable(#name, min, cur, max, &name, var_##name, true);   \
  void var_##name() { body; }
